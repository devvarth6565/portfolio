         ...
         <div className="flex px-2 pt-2 border-b border-gray-400 gap-1 bg-[#ECE9D8] shrink-0 select-none">
            {['General', 'Readme', 'Statistics'].map(tab => (
               <button
                  ...
                  className={`px-4 py-1 text-sm rounded-t-md border-t border-l border-r border-gray-400 focus:outline-none mb-[-1px] z-10 ${activeTab === tab
   ...
   return (
      <div className="w-screen h-screen overflow-hidden relative" onClick={() => setSelectedIcon(null)}>
         ...
         <div className="absolute top-4 left-4 flex flex-col gap-2 z-0">
            ...
            <DesktopIcon label="CodeSurfer Live" icon={<img src="https://win98icons.alexmeub.com/icons/png/bar_graph_default-1.png" className="w-full h-full" alt="web" />} selected={selectedIcon === 'codesurfer'} onClick={() => setSelectedIcon('codesurfer')} onDoubleClick={() => openWindow('codesurfer', 'CodeSurfer Live', { url: 'https://code-surfer-five.vercel.app/' })} />

            {/* techConnect Icon */}
            <DesktopIcon label="techConnect" icon={<img src="https://win98icons.alexmeub.com/icons/png/address_book_users.png" className="w-full h-full" alt="net" />} selected={selectedIcon === 'techconnect'} onClick={() => setSelectedIcon('techconnect')} onDoubleClick={() => openWindow('techconnect', 'techConnect', { url: 'http://3.106.246.152/' })} />

            <DesktopIcon label="GitHub" icon={<img src="https://cdn-icons-png.flaticon.com/512/25/25231.png" className="w-full h-full" alt="gh" />} selected={selectedIcon === 'github'} onClick={() => setSelectedIcon('github')} onDoubleClick={() => openWindow('github', 'GitHub Profile', { url: 'https://github.com/devvarth6565' })} />
         </div>
                        ...
                        win.id === 'computer' ? "https://cdn-icons-png.flaticon.com/512/2889/2889279.png" :
                           win.id === 'about' ? "https://cdn-icons-png.flaticon.com/512/3237/3237472.png" :
                              win.id === 'terminal' ? "https://win98icons.alexmeub.com/icons/png/console_prompt-0.png" :
                                 win.id === 'codesurfer' ? "https://win98icons.alexmeub.com/icons/png/bar_graph_default-1.png" :
                                    win.id === 'techconnect' ? "https://win98icons.alexmeub.com/icons/png/address_book_users.png" :
                                       win.id === 'github' ? "https://cdn-icons-png.flaticon.com/512/25/25231.png" :
